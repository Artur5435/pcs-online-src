...
export class OlejeSportComponent implements OnInit {
  ...
  popedCount : number = 1;
    ...
    this.oilsService.getOilsSport().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("OLEJE - KLASA SPORT");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
