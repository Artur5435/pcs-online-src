...
@Component({
  selector: 'app-oleje-przekladniowe',
...
export class OlejePrzekladnioweComponent implements OnInit {
  ...
  popedCount : number = 1;
    ...
    this.oilsService.getOilsPrzek().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("OLEJE PRZEKŁADNIOWE");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
