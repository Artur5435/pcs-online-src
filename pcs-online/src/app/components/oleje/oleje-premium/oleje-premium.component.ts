...
export class OlejePremiumComponent implements OnInit {
  ...
  popedCount : number = 1;
    ...
    this.oilsService.getOilsPremium().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("OLEJE - KLASA PREMIUM");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
