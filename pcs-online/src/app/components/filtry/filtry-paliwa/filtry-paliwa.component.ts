...
export class FiltryPaliwaComponent implements OnInit {
  items: Item[] = [];
  ...
  popedCount : number = 1;
    ...
    this.filtersService.getFiltersPaliwa().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("FILTRY PALIWA");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
