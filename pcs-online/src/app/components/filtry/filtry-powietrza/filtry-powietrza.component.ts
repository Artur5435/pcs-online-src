...
export class FiltryPowietrzaComponent implements OnInit {
  ...
  popedCount : number = 1;
    ...
    this.filtersService.getFiltersPowietrza().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("FILTRY POWIETRZA");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
