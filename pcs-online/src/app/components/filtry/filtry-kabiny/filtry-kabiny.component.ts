...
export class FiltryKabinyComponent implements OnInit {
  ...
  popedCount : number = 1;
    ...
    this.filtersService.getFiltersKabiny().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("FILTRY KABINY");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
