...
import { AkcesoriaService } from '../../../services/akcesoria.service';
import { ItemService } from '../../../services/item.service';
import { Item } from '../../../models/item';
import { trigger, transition, query, style, stagger, animate } from '@angular/animations';

@Component({
  selector: 'app-wycieraczki',
...
export class WycieraczkiComponent implements OnInit {
  ...
  popedCount : number = 1;
	...
	constructor(private accesoryService: AkcesoriaService, private itemService : ItemService) {
    this.accesoryService.getWycieraczki().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("WYCIERACZKI");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
