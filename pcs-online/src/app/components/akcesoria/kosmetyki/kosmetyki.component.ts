...
export class KosmetykiComponent implements OnInit {
  ...
  popedCount : number = 1;
    ...
    this.accesoryService.getKosmetyki().subscribe((data) => { this.items =  data;});
    this.StartSort();
   }
  ngOnInit() {
    $("#Title").text("KOSMETYKI");
    /*this.items.push({
      Producent: "VALVOLINE", 
      ID:"VAC10W404.1", 
      TypProduktu: "OLEJ",
